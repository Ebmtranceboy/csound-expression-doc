...
import Csound.Base(del,dac,mul,magicCave2,lim,at,mlp,tri,smooth,constSeq,bp,expseg,pink,uosc,uosc',lp,bat,mel,rest,atNote,mixAt,usqr,hp1, smallHall2,lp1,str,sqrSeq,upw,deepPad,sah,osc,on,blp,usqr',Tab,Sig,Patch2,tablei,withD,esplines,linseg)
import Csound.Sam(toSam,pat,linEnv,pat',atPan,limSam)

import Csound.Patch(razorPad,caveOvertonePad,whaleSongPad,wind,fmDroneMedium,black,noiz)
import Csound.Catalog.Drum.MiniPops(mar,bon1,bon2,qj,rim,tam,cl)
